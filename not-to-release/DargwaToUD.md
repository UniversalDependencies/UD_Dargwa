# Dargwa Chirag corpus tagset: conversion table to UD v2

This table is based on the Corpus of Chirag Dargwa tagset (Ganenkov, Dmitry. 2016. The Corpus of Chirag Dargwa. (Available online at http://dag-languages.org/chirag/corpus). 

| Freq | Chirag tag | Explication | FEAT | POS | Comment | Category | Tanty gloss |
|---|---|---|---|---|---|---|---|
| 1 | (M)CAUS:IPF | (masculine)causative:imperfective | Aspect=Imp!Caus=Yes!NounClass=Masc | VERB | *language-specific | aspect |  |
...
| 1 | ADEL | adelative | Case=Adelat | NOUN!PROPN!DET | *language-specific | case |  |
...
| 11 | CAUS:IPF | causative:imperfective | Aspect=Imp!Caus=Yes | VERB | *language-specific | aspect |  |
| 20 | CAUS:PF | causative:perfective | Aspect=Pfv!Caus=Yes | VERB | *language-specific | aspect |  |
| 22 | CIT | citative | _ | PART |  | PART | цитативный показатель |
| 6 | COMIT | comitative | Case=Com | NOUN!PROPN!DET |  | case | комитатив |
| 2 | COND.1 | conditional+1st person | Mood=Cnd!Person=1 | VERB |  | mood |  |
| 9 | COND.3 | conditional+3st person | Mood=Cnd!Person=3 | VERB |  | mood |  |
| 319 | CONV | converb | VerbForm=Conv | VERB |  | VERB | простое деепричастие |
| 9 | COP | copula (identifying copula) | _ | VERB |  | VERB | (идентифицирующая) связка |
...
| 20 | DEM.DOWN | demonstrative:lower than the speaker | PronType=DemDown | DET | *language-specific | demonstrative |  |
| 1 | DEM.L | demonstrative: | PronType=DemL | DET | *language-specific | demonstrative |  |
| 2 | DEM.L+DIST | demonstrative: | PronType=DemL!PronType=DemDist | DET |  | demonstrative |  |
...
| 4 | N(ESS) | non-human class (essive) | Case=Ess!NounClass=NHum | VERB | *language-specific | class |  |
